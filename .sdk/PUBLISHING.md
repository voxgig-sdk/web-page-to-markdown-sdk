...
|---|---|---|
| `ts/` | @voxgig-sdk/web-page-to-markdown-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/web-page-to-markdown-sdk \
      --repository voxgig-sdk/web-page-to-markdown-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/web-page-to-markdown-sdk` shows it, and
`npm trust revoke @voxgig-sdk/web-page-to-markdown-sdk --id=<id>` removes it.
