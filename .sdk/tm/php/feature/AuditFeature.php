...
// WebPageToMarkdown SDK audit feature
...
class WebPageToMarkdownAuditFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _emit(WebPageToMarkdownContext $ctx, string $outcome): void
    {
