...
// WebPageToMarkdown SDK idempotency feature
...
class WebPageToMarkdownIdempotencyFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _mutating(WebPageToMarkdownContext $ctx): bool
    {
