...
// WebPageToMarkdown SDK metrics feature
...
class WebPageToMarkdownMetricsFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _record(WebPageToMarkdownContext $ctx, bool $ok): void
    {
