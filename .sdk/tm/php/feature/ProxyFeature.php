...
// WebPageToMarkdown SDK proxy feature
...
class WebPageToMarkdownProxyFeature extends WebPageToMarkdownBaseFeature
{
    ...
    public function init(WebPageToMarkdownContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WebPageToMarkdownContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
