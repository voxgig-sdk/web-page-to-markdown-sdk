...
// WebPageToMarkdown SDK rbac feature
...
class WebPageToMarkdownRbacFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _required(WebPageToMarkdownContext $ctx): ?string
    {
    ...
    private function _reject(WebPageToMarkdownContext $ctx, string $required): void
    {
    ...
    private function _track(WebPageToMarkdownContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
