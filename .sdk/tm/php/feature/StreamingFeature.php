...
// WebPageToMarkdown SDK streaming feature
...
class WebPageToMarkdownStreamingFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _iterate(WebPageToMarkdownResult $result): \Generator
    {
    ...
    private function _streamable(WebPageToMarkdownContext $ctx): bool
    {
