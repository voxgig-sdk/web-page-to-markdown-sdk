...
// WebPageToMarkdown SDK telemetry feature
...
class WebPageToMarkdownTelemetryFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _close(WebPageToMarkdownContext $ctx, bool $ok): void
    {
