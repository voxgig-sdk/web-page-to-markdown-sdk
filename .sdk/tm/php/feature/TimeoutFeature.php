...
// WebPageToMarkdown SDK timeout feature
...
class WebPageToMarkdownTimeoutFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _with_timeout(WebPageToMarkdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WebPageToMarkdownContext $_ctx, float $ms): void
    {
        $client = $this->client;
