...
// WebPageToMarkdown SDK pipeline test
//
...
{
    private static function utility(): WebPageToMarkdownUtility
    {
        return new WebPageToMarkdownUtility();
    }
    ...
    private static function ctx(array $over = []): WebPageToMarkdownContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WebPageToMarkdownContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WebPageToMarkdownError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WebPageToMarkdownMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WebPageToMarkdownMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WebPageToMarkdownMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WebPageToMarkdownSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WebPageToMarkdownMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WebPageToMarkdownResponse([]),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        [, $err] = WebPageToMarkdownMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec([]),
            'response' => null,
            'result' => new WebPageToMarkdownResult([]),
        ]);
        [, $err] = WebPageToMarkdownMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec(['step' => 's']),
            'response' => new WebPageToMarkdownResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        [, $err] = WebPageToMarkdownMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec(['step' => 's']),
            'response' => new WebPageToMarkdownResponse(self::resp(200, ['v' => 1])),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        [, $err] = WebPageToMarkdownMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec(['step' => 's']),
            'response' => new WebPageToMarkdownResponse(self::resp(200, ['v' => 2])),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WebPageToMarkdownMakeResponse::call($ctx);
    ...
    {
        $preset = new WebPageToMarkdownResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec([]),
            'response' => new WebPageToMarkdownResponse([]),
            'result' => new WebPageToMarkdownResult([]),
        ...
        [$got, $err] = WebPageToMarkdownMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WebPageToMarkdownResult([])]);
        [, $err] = WebPageToMarkdownMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WebPageToMarkdownSpec([]), 'result' => null]);
        [, $err] = WebPageToMarkdownMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WebPageToMarkdownSpec(['step' => 's']),
            'result' => new WebPageToMarkdownResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WebPageToMarkdownMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WebPageToMarkdownSpec(['step' => 's']),
            'result' => new WebPageToMarkdownResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WebPageToMarkdownOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WebPageToMarkdownMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WebPageToMarkdownResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WebPageToMarkdownSpec([]),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WebPageToMarkdownMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WebPageToMarkdownMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WebPageToMarkdownError('boom', 'boom');
        $utility->fetcher = function (WebPageToMarkdownContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WebPageToMarkdownSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WebPageToMarkdownMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WebPageToMarkdownContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WebPageToMarkdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WebPageToMarkdownResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WebPageToMarkdownMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WebPageToMarkdownContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WebPageToMarkdownSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WebPageToMarkdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WebPageToMarkdownResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WebPageToMarkdownSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WebPageToMarkdownMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WebPageToMarkdownMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WebPageToMarkdownMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WebPageToMarkdownResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WebPageToMarkdownDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WebPageToMarkdownResult(['ok' => false])]);
        $this->expectException(WebPageToMarkdownError::class);
        WebPageToMarkdownDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WebPageToMarkdownResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WebPageToMarkdownMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WebPageToMarkdownMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WebPageToMarkdownBaseFeature();
        $b = new WebPageToMarkdownBaseFeature();
        WebPageToMarkdownFeatureAdd::call($ctx, $a);
        WebPageToMarkdownFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WebPageToMarkdownBaseFeature
    {
        $f = new WebPageToMarkdownBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WebPageToMarkdownFeatureAdd::call($ctx, self::named_feature('a'));
        WebPageToMarkdownFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WebPageToMarkdownFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WebPageToMarkdownFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WebPageToMarkdownFeatureAdd::call($ctx, $replace);
        ...
        WebPageToMarkdownFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WebPageToMarkdownContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WebPageToMarkdownSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WebPageToMarkdownPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WebPageToMarkdownPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WebPageToMarkdownResponse(['headers' => null]),
            'result' => new WebPageToMarkdownResult([]),
        ]);
        WebPageToMarkdownResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WebPageToMarkdownResultBody::call($ctx);
