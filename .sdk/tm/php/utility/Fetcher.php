...
// WebPageToMarkdown SDK utility: fetcher

class WebPageToMarkdownFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WebPageToMarkdownSDK/1.0)';
    ...
    public static function call(WebPageToMarkdownContext $ctx, string $fullurl, array $fetchdef): array
    {
