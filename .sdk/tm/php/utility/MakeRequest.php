...
// WebPageToMarkdown SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WebPageToMarkdownMakeRequest
{
    public static function call(WebPageToMarkdownContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WebPageToMarkdownResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WebPageToMarkdownResponse($fetched);
        } else {
