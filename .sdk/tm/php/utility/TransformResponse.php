...
// WebPageToMarkdown SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class WebPageToMarkdownTransformResponse
{
    public static function call(WebPageToMarkdownContext $ctx): mixed
    {
        ...
        $transform = WebPageToMarkdownHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
