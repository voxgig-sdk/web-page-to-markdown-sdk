...
from projectname_sdk.core.control import WebPageToMarkdownControl
...
class WebPageToMarkdownContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WebPageToMarkdownControl()
        ...
        if isinstance(sp, WebPageToMarkdownSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WebPageToMarkdownResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WebPageToMarkdownResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WebPageToMarkdownOperation({})
    ...
    def make_error(self, code, msg):
        return WebPageToMarkdownError(code, msg, self)
