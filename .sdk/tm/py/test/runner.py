...
class WebPageToMarkdownTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WebPageToMarkdownTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WebPageToMarkdownTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WebPageToMarkdownTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
