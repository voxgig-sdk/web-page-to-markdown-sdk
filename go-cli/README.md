...
AQL-driven command-line client **and** interactive REPL for the WebPageToMarkdown
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `convert_url_to_markdown_get`).
