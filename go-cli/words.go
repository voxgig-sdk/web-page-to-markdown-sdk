...
func registerSDKWords(r *eng.Registry, client *sdk.WebPageToMarkdownSDK) {
...
func runOp(client *sdk.WebPageToMarkdownSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
