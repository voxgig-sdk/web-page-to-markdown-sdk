// Command WebPageToMarkdown-mcp is an MCP server exposing the WebPageToMarkdown
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WebPageToMarkdown_list  — list records of an entity
//	WebPageToMarkdown_load  — load a single record of an entity
//
