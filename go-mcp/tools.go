...
type Args struct {
	Entity string         `json:"entity" jsonschema:"convert_url_to_markdown_get | convert_url_to_markdown_post"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WebPageToMarkdownSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "web-page-to-markdown_list",
		Description: "List records from WebPageToMarkdown. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "web-page-to-markdown_load",
		Description: "Load a single record from WebPageToMarkdown. " +
...
func runOp(client *sdk.WebPageToMarkdownSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WebPageToMarkdownSDK, name string) (sdk.WebPageToMarkdownEntity, error) {
	switch strings.ToLower(name) {
	case "convert_url_to_markdown_get":
		return client.ConvertUrlToMarkdownGet(nil), nil
	case "convert_url_to_markdown_post":
		return client.ConvertUrlToMarkdownPost(nil), nil
