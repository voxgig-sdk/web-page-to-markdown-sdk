...
The Golang SDK for the WebPageToMarkdown API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/web-page-to-markdown-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/web-page-to-markdown-sdk=../path/to/github.com/voxgig-sdk/web-page-to-markdown-sdk
```
...
```
github.com/voxgig-sdk/web-page-to-markdown-sdk/
...
The root package (`github.com/voxgig-sdk/web-page-to-markdown-sdk`) re-exports everything needed
