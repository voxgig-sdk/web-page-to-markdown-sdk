...
func main() {
    ...
    converturltomarkdownget, err := client.ConvertUrlToMarkdownGet(nil).Load(map[string]any{"id": "example_id"}, nil)
    if err != nil {
        panic(err)
    }
...
fmt.Println(converturltomarkdownget) // the loaded mock data
```
...
slice):
    ...
    converturltomarkdownget, err := client.ConvertUrlToMarkdownGet(nil).Load(map[string]any{"id": "example_id"}, nil)
    if err != nil { /* handle */ }
    // converturltomarkdownget is the loaded record
...
```go
convert_url_to_markdown_get, err := client.ConvertUrlToMarkdownGet(nil).Load(map[string]any{"id": "convert_url_to_markdown_get_id"}, nil)
if err != nil {
    panic(err)
}
...
converturltomarkdownget.Load(map[string]any{"id": "example_id"}, nil)
