...
func convert_url_to_markdown_getDirectSetup(mockres any) *convert_url_to_markdown_getDirectSetupResult {
	...
	env := envOverride(map[string]any{
		"WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_GET_ENTID": map[string]any{},
	...
	if live {
		...
		idmap := map[string]any{}
		if entidRaw, ok := env["WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_GET_ENTID"]; ok {
