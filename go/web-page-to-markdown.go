...
// instead of `sdk.NewWebPageToMarkdownSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *WebPageToMarkdownSDK  { return NewWebPageToMarkdownSDK(nil) }
func Test() *WebPageToMarkdownSDK { return TestSDK(nil, nil) }
