...
local ConvertUrlToMarkdownGetEntity = {}
ConvertUrlToMarkdownGetEntity.__index = ConvertUrlToMarkdownGetEntity


function ConvertUrlToMarkdownGetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConvertUrlToMarkdownGetEntity)
  self._name = "convert_url_to_markdown_get"
  self._client = client
...
function ConvertUrlToMarkdownGetEntity:get_name()
  return self._name
end


function ConvertUrlToMarkdownGetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConvertUrlToMarkdownGetEntity.new(self._client, opts)
end
...
function ConvertUrlToMarkdownGetEntity:mark_deleted()
  self._deleted = true
end


function ConvertUrlToMarkdownGetEntity:deleted()
  return true == self._deleted
end


function ConvertUrlToMarkdownGetEntity:data_set(args)
  if args ~= nil then
...
function ConvertUrlToMarkdownGetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConvertUrlToMarkdownGetEntity:match_set(args)
  if args ~= nil then
...
function ConvertUrlToMarkdownGetEntity:match_get()
...
function ConvertUrlToMarkdownGetEntity:stream(action, args, callopts)
...
function ConvertUrlToMarkdownGetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConvertUrlToMarkdownGetEntity
