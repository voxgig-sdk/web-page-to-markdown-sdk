...
function ConvertUrlToMarkdownPostEntity:mark_deleted()
  self._deleted = true
end


function ConvertUrlToMarkdownPostEntity:deleted()
...
function ConvertUrlToMarkdownPostEntity:stream(action, args, callopts)
