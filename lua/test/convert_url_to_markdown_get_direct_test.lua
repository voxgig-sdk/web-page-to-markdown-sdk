...
describe("ConvertUrlToMarkdownGetDirect", function()
  it("should direct-load-convert_url_to_markdown_get", function()
    local setup = convert_url_to_markdown_get_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-convert_url_to_markdown_get", setup.live and "live" or "unit")
...
function convert_url_to_markdown_get_direct_setup(mockres)
