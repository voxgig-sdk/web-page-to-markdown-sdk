...
describe("ConvertUrlToMarkdownGetEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_GET_ENTID JSON to run live")
      return
    end
...
function convert_url_to_markdown_get_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_GET_ENTID")
