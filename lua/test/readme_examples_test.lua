...
local SDK_MODULE = "web-page-to-markdown_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["convert_url_to_markdown_get"] = { ["test01"] = { id = "test01" } }, ["convert_url_to_markdown_post"] = { ["test01"] = { id = "test01" } } } }'
