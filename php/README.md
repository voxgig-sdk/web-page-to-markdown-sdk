# WebPageToMarkdown PHP SDK



The PHP SDK for the WebPageToMarkdown API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($converturltomarkdownget->data_get());
} catch (\Throwable $err) {
...
```
php/
├── webpagetomarkdown_sdk.php          -- Main SDK class
...
The main class (`webpagetomarkdown_sdk.php`) exports the SDK class
