# WebPageToMarkdown PHP SDK Reference

Complete API reference for the WebPageToMarkdown PHP SDK.
...
#### `WebPageToMarkdownSDK::test($testopts = null, $sdkopts = null)`
...
#### `ConvertUrlToMarkdownGet($data = null)`

Create a new `ConvertUrlToMarkdownGetEntity` instance. Pass `null` for no initial data.

#### `ConvertUrlToMarkdownPost($data = null)`
...
#### `make(): ConvertUrlToMarkdownGetEntity`
...
#### `make(): ConvertUrlToMarkdownPostEntity`
