...
// WebPageToMarkdown SDK utility type

class WebPageToMarkdownUtility
{
    ...
    public static function copy(WebPageToMarkdownUtility $src): WebPageToMarkdownUtility
    {
        $u = new WebPageToMarkdownUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
