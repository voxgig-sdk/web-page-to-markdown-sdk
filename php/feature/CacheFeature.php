...
// WebPageToMarkdown SDK cache feature
...
class WebPageToMarkdownCacheFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _through(WebPageToMarkdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
