...
// WebPageToMarkdown SDK clienttrack feature
...
class WebPageToMarkdownClienttrackFeature extends WebPageToMarkdownBaseFeature
{
    ...
    public function PostConstruct(WebPageToMarkdownContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WebPageToMarkdown-SDK';
