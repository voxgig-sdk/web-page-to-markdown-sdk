...
// WebPageToMarkdown SDK debug feature
...
class WebPageToMarkdownDebugFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _finish(WebPageToMarkdownContext $ctx, bool $ok): void
    {
