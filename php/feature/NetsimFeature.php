...
// WebPageToMarkdown SDK netsim feature
...
class WebPageToMarkdownNetsimFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _simulate(WebPageToMarkdownContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WebPageToMarkdownContext $ctx, array $applied): void
    {
        $client = $this->client;
