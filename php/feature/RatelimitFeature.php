...
// WebPageToMarkdown SDK ratelimit feature
...
class WebPageToMarkdownRatelimitFeature extends WebPageToMarkdownBaseFeature
{
    ...
    private function _acquire(WebPageToMarkdownContext $ctx): void
    {
    ...
    private function _track(WebPageToMarkdownContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
