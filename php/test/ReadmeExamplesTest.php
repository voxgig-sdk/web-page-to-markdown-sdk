...
// WebPageToMarkdown SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WebPageToMarkdownSDK::test)
...
{
    private const SDK_CLASS = 'WebPageToMarkdownSDK';
    ...
    private const SDK_BASE = 'webpagetomarkdown_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../webpagetomarkdown_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
