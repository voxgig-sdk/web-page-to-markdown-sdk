...
// WebPageToMarkdown SDK utility: graphql
//
...
class WebPageToMarkdownGraphql
{
    ...
    // equivalent.
    public static function body(WebPageToMarkdownContext $ctx): mixed
    {
    ...
    public static function errors(WebPageToMarkdownContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
