...
// WebPageToMarkdown SDK utility: make_options

class WebPageToMarkdownMakeOptions
{
    ...
    public static function call(WebPageToMarkdownContext $ctx): array
    {
        ...
        //
        // `WebPageToMarkdownSchema::optspec()` is built from the model:
        ...
        $optspec = WebPageToMarkdownSchema::optspec();
