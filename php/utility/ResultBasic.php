...
// WebPageToMarkdown SDK utility: result_basic

class WebPageToMarkdownResultBasic
{
    public static function call(WebPageToMarkdownContext $ctx): ?WebPageToMarkdownResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof WebPageToMarkdownError) ? $result->err->msg : (string)$result->err;
