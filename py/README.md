# WebPageToMarkdown Python SDK



The Python SDK for the WebPageToMarkdown API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.ConvertUrlToMarkdownGet()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/web-page-to-markdown-sdk/releases)) or
...
```
py/
├── webpagetomarkdown_sdk.py         -- Main SDK module
