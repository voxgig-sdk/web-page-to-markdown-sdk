    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_POST_ENTID JSON to run live")
        client = setup["client"]
        ...
        convert_url_to_markdown_post_ref01_data = helpers.to_map(runner.entity_data(convert_url_to_markdown_post_ref01_ent.create(convert_url_to_markdown_post_ref01_data, None)))
...
def _convert_url_to_markdown_post_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_POST_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_POST_ENTID"))
