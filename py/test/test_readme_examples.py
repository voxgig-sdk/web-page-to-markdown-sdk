# WebPageToMarkdown SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WebPageToMarkdownSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WebPageToMarkdownSDK(...) and WebPageToMarkdownSDK.test(...) become
#      WebPageToMarkdownSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "webpagetomarkdown_sdk"
_SDK_CLASS = "WebPageToMarkdownSDK"
...
_ENTITIES = {
    "ConvertUrlToMarkdownGet": "convert_url_to_markdown_get",
    "ConvertUrlToMarkdownPost": "convert_url_to_markdown_post",
}
