...
from webpagetomarkdown_sdk.utility import register

# Load features
from webpagetomarkdown_sdk.feature.base_feature import WebPageToMarkdownBaseFeature
from webpagetomarkdown_sdk.features import _has_feature, _make_feature
...
class WebPageToMarkdownSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WebPageToMarkdownUtility()
        self._utility = utility

        from webpagetomarkdown_sdk.config import shared_config
    ...
    def get_utility(self):
        return WebPageToMarkdownUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WebPageToMarkdownSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ConvertUrlToMarkdownGet(self, data=None) -> "ConvertUrlToMarkdownGetEntity":
        ...
        from webpagetomarkdown_sdk.entity.convert_url_to_markdown_get_entity import ConvertUrlToMarkdownGetEntity
    ...
    def ConvertUrlToMarkdownPost(self, data=None) -> "ConvertUrlToMarkdownPostEntity":
        ...
        from webpagetomarkdown_sdk.entity.convert_url_to_markdown_post_entity import ConvertUrlToMarkdownPostEntity
