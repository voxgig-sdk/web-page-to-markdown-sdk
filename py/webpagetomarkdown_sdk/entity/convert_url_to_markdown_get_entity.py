...
from webpagetomarkdown_sdk.webpagetomarkdown_types import (
...
class ConvertUrlToMarkdownGetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConvertUrlToMarkdownGetEntity(self._client, opts)
    ...
    def data_get(self) -> ConvertUrlToMarkdownGet:
    ...
    def match_get(self) -> ConvertUrlToMarkdownGet:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConvertUrlToMarkdownGet:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConvertUrlToMarkdownGet().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
