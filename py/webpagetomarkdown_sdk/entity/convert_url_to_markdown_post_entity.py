...
class ConvertUrlToMarkdownPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConvertUrlToMarkdownPostEntity(self._client, opts)
    ...
    def data_get(self) -> ConvertUrlToMarkdownPost:
    ...
    def match_get(self) -> ConvertUrlToMarkdownPost:
    ...
    def create(self, reqdata: ConvertUrlToMarkdownPostCreateData, ctrl=None) -> ConvertUrlToMarkdownPost:
        utility = self._utility
