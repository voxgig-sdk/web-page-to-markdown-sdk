...
class ConvertUrlToMarkdownPostEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "convert_url_to_markdown_post"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    ConvertUrlToMarkdownPostEntity.new(@_client, opts)
  end
  ...
  # @return [ConvertUrlToMarkdownPost, Hash] the current ConvertUrlToMarkdownPost data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConvertUrlToMarkdownPost fields)
  def match_get
  ...
  #
  # @param reqdata [ConvertUrlToMarkdownPostCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConvertUrlToMarkdownPost, Hash] the created ConvertUrlToMarkdownPost; raises WebPageToMarkdownError on failure
