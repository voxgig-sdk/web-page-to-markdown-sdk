...
#      offline in seeded test mode (WebPageToMarkdownSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WebPageToMarkdown_sdk.rb")
  SDK_CLASS = "WebPageToMarkdownSDK"
  ...
  SDK_BASE = "WebPageToMarkdown_sdk"
