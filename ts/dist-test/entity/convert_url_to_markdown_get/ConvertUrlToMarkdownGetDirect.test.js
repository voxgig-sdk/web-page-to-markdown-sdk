...
(0, node_test_1.describe)('ConvertUrlToMarkdownGetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WebPageToMarkdownSDK({
    ...
    (0, node_test_1.test)('direct-load-convert_url_to_markdown_get', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-convert_url_to_markdown_get', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.WEB_PAGE_TO_MARKDOWN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WebPageToMarkdownSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WEB_PAGE_TO_MARKDOWN_TEST_CONVERT_URL_TO_MARKDOWN_GET_ENTID'];
    ...
    const client = new __1.WebPageToMarkdownSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConvertUrlToMarkdownGetDirect.test.js.map